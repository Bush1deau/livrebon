 ...
 */
final class Version20230216145743 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE livraison (id INT AUTO_INCREMENT NOT NULL, livrer_id INT DEFAULT NULL, secteur_id INT DEFAULT NULL, date DATE NOT NULL, heure TIME NOT NULL, lieu VARCHAR(255) NOT NULL, destination VARCHAR(255) NOT NULL, INDEX IDX_A60C9F1F534C185D (livrer_id), INDEX IDX_A60C9F1F9F7E4405 (secteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
